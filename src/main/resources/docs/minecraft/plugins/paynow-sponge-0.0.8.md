# paynow-sponge-0.0.8 API Reference
...
### Class: gg.paynow.paynowsponge.PayNowSponge
Type: Class

Methods:
- V onServerStopping(StoppingEngineEvent<Server>)
- void triggerConfigUpdate()
- V onRegisterCommands(RegisterCommandEvent<Command$Parameterized>)
- PayNowLib getPayNowLib()
- V onServerStart(StartedEngineEvent<Server>)

### Class: gg.paynow.paynowsponge.PayNowSpongeCommand
Type: Class

Methods:
- **static** Command$Parameterized generate(PayNowSponge)
