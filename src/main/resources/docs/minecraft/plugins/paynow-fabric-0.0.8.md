# paynow-fabric-0.0.8 API Reference

## Package: gg.paynow.paynowfabric

### Class: gg.paynow.paynowfabric.PayNowFabric
Type: Class
...
### Class: gg.paynow.paynowfabric.PayNowFabricCommand
Type: Class

Methods:
- **static** LiteralArgumentBuilder<class_2168> generateCommand(PayNowFabric)
