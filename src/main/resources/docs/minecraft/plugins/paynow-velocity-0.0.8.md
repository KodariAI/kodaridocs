# paynow-velocity-0.0.8 API Reference
...
### Class: gg.paynow.paynowvelocity.PayNowVelocity
Type: Class

Methods:
- void onProxyInitialization(ProxyInitializeEvent)
- void triggerConfigUpdate()
- void onProxyShutdown(ProxyShutdownEvent)
- PayNowLib getPayNowLib()

### Class: gg.paynow.paynowvelocity.PayNowVelocityCommand
Type: Class

Methods:
- **static** BrigadierCommand generateCommand(PayNowVelocity)
