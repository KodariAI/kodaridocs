# citizensapi-2.0.41-SNAPSHOT API Reference
...
- boolean withinMargin(Location a, Location b)
- boolean withinMargin(Location a, Location b, double margin)
- boolean withinMargin(Vector a, Vector b)
...
- void checkedRunRegionTask(Location location, Runnable runnable)
...
- void checkedRunEntityTask(Entity entity, Runnable runnable)
